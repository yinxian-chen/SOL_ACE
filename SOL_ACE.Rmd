...
sol.ana.1<-sol.ana.1%>%mutate(fa_edu = factor(ifelse(PIEA22A!=7,PIEA22A,
...
sol.ana.1<-sol.ana.1%>%mutate(ma_edu = factor(ifelse(PIEA23A!=7,PIEA23A,
...
table(sol.ana.1$ma_edu)
table(sol.ana.1$fa_edu)
table(is.na(sol.ana.1$ma_edu))
table(is.na(sol.ana.1$fa_edu))

#sol.ana.1<-sol.ana.1%>%select(-c(PIEA22B,PIEA23B,PIEA22A,PIEA23A))
