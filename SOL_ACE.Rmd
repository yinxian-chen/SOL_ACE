...
kable(test, booktabs = T, digits = 3)%>% add_header_above(c(" " = 1,"GEE" = 4, "GLM" = 4))%>% pack_rows(index = c("GrimAA"=12, "GrimAge"=12,"DunedinPACE"=12))%>%
...
kable(test.1, booktabs = T, digits = 3)%>% add_header_above(c(" " = 1,"GEE" = 4, "GLM" = 4))%>% pack_rows(index = c("GrimAA"=6, "GrimAge"=6,"DunedinPACE"=6))%>%
...
kable(test.2, booktabs = T, digits = 3)%>% add_header_above(c(" " = 1,"GEE" = 4, "GLM" = 4))%>% pack_rows(index = c("GrimAA"=10, "GrimAge"=10,"DunedinPACE"=10))%>%
...
kable(test.3, booktabs = T, digits = 3)%>% add_header_above(c(" " = 1, "GLM" = 4))%>% pack_rows(index = c("GrimAA"=12, "GrimAge"=12,"DunedinPACE"=12))%>%
  pack_rows(index = rep(c("Model 1" = 3, "Model 2" = 3),6))
```
...
kable(test.4, booktabs = T, digits = 3)%>% add_header_above(c(" " = 1, "GEE" = 4, "GLM" = 4))%>% pack_rows(index = c("GrimAA"=6, "GrimAge"=6,"DunedinPACE"=6))%>%
