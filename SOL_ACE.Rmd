...
test.res<-lme(eaa_grim~ma_ace_c2+fe_ace_c2+age_change+ma_ace_c2:age_change+fe_ace_c2:age_change+GENDER+ AGE,
              data = sol.ana.long.cca,
              random = ~1+age_change|ID,
              weights = varFixed(~WEIGHT_NORM_OVERALL_EPIGEN),
              method = "REML",
              na.action = na.omit)
...
test.res.1<-lme(eaa_grim~ma_ACE_TOT+fe_ACE_TOT+age_change+ma_ACE_TOT:age_change+fe_ACE_TOT:age_change+GENDER,
              data = sol.ana.long.cca,
              random = ~1+age_change|ID,
              weights = varFixed(~WEIGHT_NORM_OVERALL_EPIGEN),
              method = "REML",
